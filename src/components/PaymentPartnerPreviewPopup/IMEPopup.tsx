...
const IMEPopup = ({ isOpen, setIsOpen }: any) => {
  const closePopup = () => {
    setIsOpen(false);
  };
      ...
      <Dialog as="div" className="relative z-30" onClose={closePopup}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-[500px] transform overflow-hidden bg-white p-6 text-left align-middle shadow-xl transition-all">
                <Dialog.Title
                  as="h3"
                ...
                <div className="my-4 w-full rounded-md border border-primary p-6">
                  <p className="border-secondary mx-auto w-fit border-b-2 pb-1 text-2xl font-medium">
                    Bank Account
                  </p>
                  ...
                  <div className="mt-8 space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <p className="ml-auto text-lg">MIDAS</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <p className="ml-auto text-lg">Global IME Bank</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <p className="ml-auto text-lg">750101XXXXXXXXXX</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <p className="text-lg font-medium">Branch:</p>

                      <p className="ml-auto text-lg">Dharan</p>
                    </div>
                  </div>
                </div>
              </Dialog.Panel>
